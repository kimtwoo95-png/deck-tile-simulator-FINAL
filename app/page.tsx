...
const dotColorOptions: { key: DotColorKey; label: string; color: string }[] = [
  ...
  { key: "tealgreen", label: "틸그린", color: "#3E7C6D" },
  { key: "lemon", label: "레몬", color: "#FFF27A" },
  { key: "toffee", label: "토피", color: "#B08968" },
  { key: "lavender", label: "라벤더", color: "#C8B6E2" },
